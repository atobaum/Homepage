...
class Parser {
    ...
    parseList(toks, env) {
        let list = [], curOrdered = toks[0].ordered, curLevel = toks[0].level;
    ...
    out(src, ns, pageTitle) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            env.existingPages = yield this.wiki.existingPages(info.link, ns);
            ...
            if (ns === "Category") {
                content += yield this.wiki.getPageList(pageTitle).then((pageList) => __awaiter(this, void 0, void 0, function*() {
