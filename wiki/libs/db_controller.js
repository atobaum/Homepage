...
var regexTitle = /^(?:(.*?):)?(.+?)$/;
var dbController = function(config, additional){
    ...
    this.wiki = additional.wiki;
};


dbController.prototype.getPageInfo = function(title, callback){
 ...
 */
dbController.prototype.checkAC = function(nsId, pageId, userId, type, callback){
 ...
 * @property page.text
 */
dbController.prototype.getRawPage = function(title, userId, callback){
    var thisClass = this;
...
dbController.prototype.updatePageCache = function(page_id, rev_id, callback){
    var thisClass = this;
    ...
    thisClass.conn.query(query, [page_id, rev_id], function (err, rows) {
        if(err) callback(err);
            ...
            var content = thisClass.wiki.parse(rows[0].text);
...
dbController.prototype.getParsedPage = function(title, userId, callback){
    var thisClass = this;
    async.waterfall([function(next){
        thisClass.getPageInfo(title, next);
    }, function(pageInfo, next){
 ...
 * @param callback(err)
 */
dbController.prototype.editPage = function(page, userId, callback){
...
dbController.prototype.deletePage = function(title, userId, callback){
